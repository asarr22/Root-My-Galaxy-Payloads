...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x000d9ba0ULL
...
#define P0_FINGERPRINT_HEADER \
  "targets/pa3q-S938BXXUCZZI4/p0_fingerprint.h"
#endif
...
#define ASHMEM_MISC_FOPS_OFF 0x024bcd80ULL
#define ASHMEM_FOPS_OFF 0x01437480ULL
#define ASHMEM_IOCTL_OFF 0x00d7e6c0ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00d7ed7cULL
#define ASHMEM_MMAP_OFF 0x00d7edd0ULL
#define ASHMEM_OPEN_OFF 0x00d7eff0ULL
#define ASHMEM_RELEASE_OFF 0x00d7f078ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00d7f104ULL
#define CONFIGFS_READ_ITER_OFF 0x004983d4ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00498900ULL
#define COPY_SPLICE_READ_OFF 0x004190ccULL
#define NOOP_LLSEEK_OFF 0x003cb7f8ULL
#define INIT_TASK_OFF 0x0234e2c0ULL
#define ROOT_TASK_GROUP_OFF 0x0255df80ULL
#define SELINUX_ENFORCING_OFF 0x025a0810ULL
#define KMALLOC_CACHES_OFF 0x0180e578ULL
#define ANON_PIPE_BUF_OPS_OFF 0x01278148ULL
...
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x000d1278ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x0233ac60ULL
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01791639ULL
...
#define SLIDE_SYSCTL_BOOTID_OFF 0x02683910ULL
